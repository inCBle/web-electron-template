...
ipcRenderer.invoke 是 electron 7 中添加的新 api，也可以使用 ipcRenderer.send 跟 ipcRenderer.sendSync 来实现双向通信，但并不推荐。其原因便是开发代码的冗余跟同步代码带来的性能阻塞问题。[参考](https://electron.org/docs/latest/tutorial/ipc#note-legacy-approaches)
